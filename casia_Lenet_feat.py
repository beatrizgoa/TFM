...
def evaluate_lenet5(learning_rate_init=0.009, n_epochs=200, nkerns=[56, 156, 256, 254, 106], batch_size=30):
    ...
    del eliminar_test, eliminar_train, X_train, X_test, name_train
    ...
    layer0_input = x.reshape((batch_size, 5, 128, 128))
    ...
    layer0 = LeNetConvPoolLRNLayer(
        rng,
        input=layer0_input,
        image_shape=(batch_size, 5, 128, 128),
        filter_shape=(nkerns[0], 5, 11, 11),    # Si uso strid
        stride=(1, 1),
        lrn=True,
        poolsize=(2, 2),
    ...
    del y_pred_test, y_probabilidad
    ...
    del validation_losses, test_scores, Softmax_predictions, Softmax_probabilities, predictions_aux
    ##############    LDA   ###################
